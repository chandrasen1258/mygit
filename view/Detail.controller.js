jQuery.sap.require("com.mohawk.barcode.util.Formatter");
jQuery.sap.require("com.mohawk.barcode.util.Controller");

com.mohawk.barcode.util.Controller.extend("com.mohawk.barcode.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.mohawk.barcode.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.mohawk.barcode.view.NotFound",
			targetViewType: "XML"
		});
	},
