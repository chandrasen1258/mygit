...
com.mohawk.barcode.util.Controller.extend("com.mohawk.barcode.view.Master", {
	/**
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.mohawk.barcode.view.Detail",
			targetViewType: "XML"
		});
	...
	/**
	 *@memberOf com.mohawk.barcode.view.Master
	 */
