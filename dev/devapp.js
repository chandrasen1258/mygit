jQuery.sap.declare("com.mohawk.barcode.dev.devapp");
jQuery.sap.require("com.mohawk.barcode.dev.devlogon");

com.mohawk.barcode.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = com.mohawk.barcode.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new com.mohawk.barcode.dev.devlogon();
