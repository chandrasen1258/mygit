jQuery.sap.declare("com.mohawk.barcode.Component");
jQuery.sap.require("com.mohawk.barcode.dev.devapp");
jQuery.sap.require("com.mohawk.barcode.MyRouter");

sap.ui.core.UIComponent.extend("com.mohawk.barcode.Component", {
	metadata: {
		name: "TDG Demo App",
		version: "1.0",
		includes: [],
		...
		rootView: "com.mohawk.barcode.view.App",

		config: {
			resourceBundle: "i18n/messageBundle.properties",
			serviceConfig: {
				name: "OData.svc",
				serviceUrl: "proxy/http/services.odata.org/V2/(S(3mozsknk0xzsyrrfewroso31))/OData/OData.svc/"
			}
		},

		routing: {
			config: {
				routerClass: com.mohawk.barcode.MyRouter,
				viewType: "XML",
				viewPath: "com.mohawk.barcode.view",
	...
	init: function() {
		...
		var oRootPath = jQuery.sap.getModulePath("com.mohawk.barcode");
		...
		var oModel;
		var externalURL = com.mohawk.barcode.dev.devapp.externalURL;
		var appContext;
		if (com.mohawk.barcode.dev.devapp.devLogon) {
			appContext = com.mohawk.barcode.dev.devapp.devLogon.appContext;
		}
